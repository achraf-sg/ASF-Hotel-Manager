...
//                 view.populateProduitTable(hotel.getListProd()); // Add this line to refresh the table
...
//                         new UpdateProduitController(hotel, produit, updatePage, view); // Pass view reference
