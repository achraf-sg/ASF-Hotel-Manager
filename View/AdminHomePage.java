...
//         // Sidebar
//         List<String> pages = Arrays.asList("Employees", "Reservations", "Rooms", "Products");
//         Runnable[] actions = {
//             () -> {
...
//             },
//             () -> {
//                 ReservationPage reservationPage = new ReservationPage(hotel.getListRes(), hotel.getListTypes());
//                 new ReservationPageController(hotel, reservationPage);
