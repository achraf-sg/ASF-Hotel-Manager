...
public class CheckInFormPanel extends JPanel {
    ...
    public CheckInFormPanel(Reservation reservation, Vector<Chambre> availableRooms) {
    ...
    public void generateClientFields(int maxClients) {
        ...
        for (int i = 0; i < maxClients; i++) {
            ...
            // Address field
            JPanel addressPanel = createLabeledField("Address:");
            fields[3] = new JTextField(20);
            fields[3].setFont(StyleConfig.NORMAL_FONT);
            addressPanel.add(fields[3]);
            clientPanel.add(addressPanel);
