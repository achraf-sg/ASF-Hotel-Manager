...
public class EmployeePage extends JFrame {
    ...
    public EmployeePage(Vector<Employe> employees) {
        ...
        // Populate table
        remplirTableEmployes(employees);
    ...
    public void remplirTableEmployes(Vector<Employe> employees) {
        ...
        for (Employe emp : employees) {
            String role = emp instanceof Menage ? "Cleaner" : emp instanceof Reception ? "Receptionist" : "Unknown";
    ...
    public void clearForm() {
        ...
        functionComboBox.setSelectedIndex(0); // Reset the dropdown to the first option
    }
    ...
    public static void main(String[] args) {
        // Initialize the Hotel object using DataInitializer
        Hotel hotel = DataInitializer.initializeHotel();

        // Get the list of employees from the Hotel object
